...
param_grid = dict(RFE__n_features_to_select=[10, 20, 30, 40, 50], classifier__C=[0.001, 0.01, 0.1, 1, 10, 100, 1000], classifier__gamma=[1, 0.1, 0.001, 0.0001])
...
for train_index, test_index in kf.split(X_df):
    ...
    print("Feature_importances_ {0}".format(estimator.named_steps['classifier'].coef_))
    print("Number of selected features {0}".format(estimator.named_steps['RFE'].n_features_to_select))
    print("Class Weight {0}".format(estimator.named_steps['classifier'].class_weight_))
