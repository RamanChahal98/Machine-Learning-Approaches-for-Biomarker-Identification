...
#param_grid = dict(RFE__n_features_to_select=[10], classifier__C=[0.1])
param_grid = dict(RFE__n_features_to_select=[10, 20, 30, 40, 50], classifier__C=[0.001, 0.01, 0.1, 1, 10, 100, 1000])
...
plt.title('ROC RFE-Logistic Regression')
