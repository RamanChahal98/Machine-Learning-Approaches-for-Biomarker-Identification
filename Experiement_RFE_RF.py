...
# X, y as data frame not numpy array
...
for train_index, test_index in kf.split(X_df):
    ...
    print("Feature_importances_ {0}".format(estimator.named_steps['classifier'].feature_importances_))
    ...
    other_data["Feature Importances"] = estimator.named_steps['classifier'].feature_importances_
...
compiled_data.to_csv("/home/ramona_lisa/uni/Final Project/Rfe/Updated_Figs/OriginalTest_RFE_RF/RFE-RF Scores.csv")
print(compiled_data)
print()
