...
#param_grid = dict(ReliefF__n_features_to_select=[2,3,4,5], classifier__max_depth=[10], classifier__n_estimators=[100])
#param_grid = dict(ReliefF__n_features_to_select=[2,3,4,5,6,7,8,9,10], classifier__max_depth=[2, 3, 4, 10], classifier__n_estimators=[100, 200, 500])
param_grid = dict(ReliefF__n_features_to_select=[10, 20, 30, 40, 50], classifier__max_depth=[2, 3, 4, 5], classifier__n_estimators=[100, 200, 500, 1000])
...
for train_index, test_index in kf.split(X_df):
    ...
    other_data.to_csv(path_or_buf="/home/ramona_lisa/uni/Final Project/Rfe/Updated_Figs/Experiment_Relief_RF/" + str(i) + "Relief-RF_AdditionalData.csv")
    ...
    feature_importance["Feature Importance"] = estimator.named_steps['classifier'].feature_importances_
    ...
    def feature_importance_plot():
        ...
        # Save Fig
        filename = "/home/ramona_lisa/uni/Final Project/Rfe/Updated_Figs/Experiment_Relief_RF/SHAP_Plot/" + str(get_scores()) + "Feature_Importance-Relief-RF" + ".png"
...
plt.title('ROC Relief-RF')
plt.legend(loc="lower right")
# Tight layout
plt.tight_layout()
filename = "/home/ramona_lisa/uni/Final Project/Rfe/Updated_Figs/Experiment_Relief_RF/ROC_Curves/" + "ROC Relief-RF" + ".png"
...
compiled_data.to_csv("/home/ramona_lisa/uni/Final Project/Rfe/Updated_Figs/Experiment_Relief_RF/Relief-RF Scores.csv")
print(compiled_data)
print()
